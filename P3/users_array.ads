...
package Users is
        ...
        package ASU renames Ada.Strings.Unbounded;
       	...
       	procedure Buscar_Nick(Cliente: in out Clients_List; EP: LLU.End_Point_Type; Nick: out ASU.Unbounded_String; Max : Natural);
       ...
       type Client is record
       	...
       	type Clients_List is array(1..50) of Client;
